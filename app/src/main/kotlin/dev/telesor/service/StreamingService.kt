...
import dev.telesor.ui.MainActivity
...
class StreamingService : Service() {
    ...
    var channel: TelesorChannel? = null
        private set
     ...
     */
    fun initSession(ch: TelesorChannel, role: DeviceRole) {
        channel = ch
    ...
    companion object {
        private const val CHANNEL_ID = "telesor_streaming"
        private const val NOTIFICATION_ID = 1001
        const val EXTRA_ROLE = "role"
        const val ACTION_STOP_CAMERA = "dev.telesor.STOP_CAMERA"
        const val ACTION_STOP_NFC = "dev.telesor.STOP_NFC"
