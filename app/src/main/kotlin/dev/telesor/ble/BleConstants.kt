...
/** BLE constants for Telesor discovery and pairing. */
object BleConstants {
    /** Custom GATT service UUID for Telesor. */
    ...
    /** Magic bytes to identify Telesor advertisements. */
    val ADVERTISEMENT_MAGIC = byteArrayOf(0x54, 0x4C, 0x53, 0x52) // "TLSR"
}
