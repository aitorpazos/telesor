...
/**
 * Discovered Telesor device from BLE scan.
 */
...
class BleDiscoveryManager(private val context: Context) {
    ...
    /**
     * Start advertising this device as a Telesor [role].
     */
    ...
    /**
     * Scan for nearby Telesor devices. Emits discovered devices as a Flow.
     */
    @SuppressLint("MissingPermission")
