...
private const val TAG = "TelesorChannel"
 ...
 * Tag 0x02 = JSON control message (TelesorPacket)
 */
class TelesorChannel(
    ...
    val incomingPackets = Channel<TelesorPacket>(Channel.BUFFERED)
                ...
                while (isActive) {
                    ...
                    when (tag) {
                        ...
                        CONTROL_TAG -> {
                            ...
                            val packet = json.decodeFromString<TelesorPacket>(jsonStr)
    ...
    suspend fun send(packet: TelesorPacket) = withContext(Dispatchers.IO) {
